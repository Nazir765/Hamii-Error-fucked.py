...
def main_apv():
    ...
    print(logo)
    try:
        key1=open('/data/data/com.termux/files/usr/bin/.ROSS-cov', 'r').read()
    except IOError:
        os.system("clear")
        print(logo)
        ...
        print (' \x1b[1;91m[\x1b[1;93m•\x1b[1;91m]\x1b[1;93m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●')
        kok=open('/data/data/com.termux/files/usr/bin/.ROSS-cov', 'w')
        kok.write(myid+imt)
        kok.close()
        print ("")
        print ("PAID PKR 300")
        ...
        os.system('am start https://wa.me/+923025669429?text=' + tks)
        
    r1=requests.get("https://pastebin.com/raw/MnCD6E7A.txt").text
    if key1 in r1:
        hamii()
    else:
        os.system("clear")
